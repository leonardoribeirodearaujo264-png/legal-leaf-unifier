      ...
      while (hasMore) {
        ...
        if (items.length === 0) {
          ...
          const batch = items.map((customer: any) => ({
            ...
            tax_id: customer.tax_id || customer.document || customer.identification || null,
            cpf: customer.cpf || customer.individual_registration || customer.identification || null,
            ...
            rg: customer.rg || customer.identity_card || customer.document || null,
            orgao_emissor: customer.orgao_emissor || customer.issuing_body || customer.issuing_agency || null,
            nacionalidade: customer.nacionalidade || customer.nationality || customer.country || null,
            ...
            bairro: customer.bairro || customer.neighborhood || customer.district || customer.region || null,
            cidade: customer.cidade || customer.city || null,
            estado: customer.estado || customer.state || customer.uf || null,
            cep: customer.cep || customer.zip_code || customer.zipcode || customer.postal_code || customer.postalcode || null,
            telefone_fixo: customer.telefone_fixo || customer.landline || customer.home_phone || customer.phone || null,
