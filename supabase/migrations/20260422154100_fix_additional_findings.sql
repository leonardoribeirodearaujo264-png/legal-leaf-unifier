...
-- =============================================================================
-- Fim. Após esta migration, restarão no scanner:
--   * 1 Error: "AI Edge Functions Open to Unauthenticated Abuse" — atacamos
--     em commit separado (adicionar auth check nas ~15 funções de IA).
--   * Warnings: realtime publication, leaked password protection,
--     TOTP client-side check, public bucket listing — resolvidos em
--     etapas seguintes.
-- =============================================================================
