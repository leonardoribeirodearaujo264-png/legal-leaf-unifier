...
SELECT * FROM (VALUES
  (
    ...
    'google/gemini-2.5-flash', '⚖️', 'slate',  TRUE, TRUE, NULL, NULL
  ),
  (
    ...
    'google/gemini-2.5-flash', '🏛️', 'blue',   TRUE, TRUE, NULL, NULL
  ),
  (
    ...
    'google/gemini-2.5-flash', '💼', 'green',  TRUE, TRUE, NULL, NULL
  ),
  (
    ...
    'google/gemini-2.5-flash', '🏦', 'yellow', TRUE, TRUE, NULL, NULL
  ),
  (
    ...
    'google/gemini-2.5-flash', '🛒', 'orange', TRUE, TRUE, NULL, NULL
  ),
  (
    ...
    'google/gemini-2.5-flash', '👨‍👩‍👧', 'pink',  TRUE, TRUE, NULL, NULL
  ),
  (
    'Especialista Cível',
    ...
    'google/gemini-2.5-flash', '📋', 'blue',   TRUE, TRUE, NULL, NULL
  ),
  (
    ...
    'google/gemini-2.5-flash', '📑', 'purple', TRUE, TRUE, NULL, NULL
  ),
  (
    ...
    'google/gemini-2.5-flash', '🔍', 'slate',  TRUE, TRUE, NULL, NULL
  ),
  (
